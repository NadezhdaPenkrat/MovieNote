...
public class StatusJpaRepositoryTests {
    ...
    @Test
    @Sql(scripts = "classpath:/data_sql/statuses.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    public void testGetStatusByName() {

        final String statusName = "Viewed";
        Status status = statusJpaRepository.save();
        Status statusGetByName = (Status) statusJpaRepository.findByName(String.valueOf(statusJpaRepository));
    ...
    private class StatusJpaRepository {
        ...
        public Object findByName(String statusName) {
